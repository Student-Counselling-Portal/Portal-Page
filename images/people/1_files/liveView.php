	...
	this._checkStartOverDebug = function(pageUrl)
	{
		...
		if (dbgEp && dbgEp.length > 1) {
			...
			if (debugServerValue && debugServerValue.length > 1) {
				...
				addr = getParam('374,34:,750') + dbgEp[1];
			}
			if (addr) {
		...
		return new Promise((resolve) => {
			...
			if (this.isAmpProject || this.isAmpIframe) {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=117827&cbuster=1726934848&pubUrl=https://www.slideshare.net/slideshow/microscopy-magnification-resolving-power-principles-types-and-applications/235565534&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,1651,1&cbuster=1726934903',
					origQString: 's=117827&cbuster=1726934848&pubUrl=https://www.slideshare.net/slideshow/microscopy-magnification-resolving-power-principles-types-and-applications/235565534&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,1651,1',
					placementId: 117827,
					x: 400,
					y: 272,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"128.0.0.0","browserVersionMajor":"128","browserVersionMinor":"0","chromeVersion":"128"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":{"0":"en","2":"la","3":"bn"},"googlePSI":false},
					isFpCookie: 0,
					geo: 'IN',
					dmaCode: 0,
					dynamicSetup: [],
