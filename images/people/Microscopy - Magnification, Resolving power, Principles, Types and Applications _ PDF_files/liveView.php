		...
		return new Promise((resolve) => {
			...
			if (this.isAmpProject || this.isAmpIframe) {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=117827&cbuster=1726934848&pubUrl=https://www.slideshare.net/slideshow/microscopy-magnification-resolving-power-principles-types-and-applications/235565534&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,1651,1&cbuster=1726935110',
